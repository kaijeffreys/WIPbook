...
-   **Profile curvature**: the curvature in the direction of the maximum slope![](Data/profcurv.png){width="80%"}

-   **Planar curvature**: the curvature that is perpendicular to the direction of the maximum slope (sideways curvature)![](Data/plancurv.png){width="80%"}
